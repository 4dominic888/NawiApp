...
class $HiddenStudentViewDAOVersionViewData extends DataClass {
  final String id;
  final String name;
  final int age;
  final DateTime timestamp;
  const $HiddenStudentViewDAOVersionViewData(
      {required this.id,
      required this.name,
      required this.age,
      required this.timestamp});
  factory $HiddenStudentViewDAOVersionViewData.fromJson(
      Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return $HiddenStudentViewDAOVersionViewData(
      id: serializer.fromJson<String>(json['id']),
      name: serializer.fromJson<String>(json['name']),
      age: serializer.fromJson<int>(json['age']),
      timestamp: serializer.fromJson<DateTime>(json['timestamp']),
  ...
  $HiddenStudentViewDAOVersionViewData copyWith(
          {String? id, String? name, int? age, DateTime? timestamp}) =>
      $HiddenStudentViewDAOVersionViewData(
        id: id ?? this.id,
        name: name ?? this.name,
        age: age ?? this.age,
        timestamp: timestamp ?? this.timestamp,
  ...
  @override
  String toString() {
    return (StringBuffer('\$HiddenStudentViewDAOVersionViewData(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('age: $age, ')
          ..write('timestamp: $timestamp')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is $HiddenStudentViewDAOVersionViewData &&
          other.id == this.id &&
          other.name == this.name &&
          other.age == this.age &&
          other.timestamp == this.timestamp);
...
class $HiddenStudentViewDAOVersionView extends ViewInfo<
    ...
    $HiddenStudentViewDAOVersionViewData> implements HasResultSet {
  final String? _alias;
  @override
  final DatabaseAtV3 attachedDatabase;
  ...
  @override
  $HiddenStudentViewDAOVersionViewData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return $HiddenStudentViewDAOVersionViewData(
      id: attachedDatabase.typeMapping
