...
void main() {
  ...
  test("Correcta estructura de pdf en fechas", () async {
    ...
    final outputFile = File('${outputDir.path}/date_report.pdf');
  ...
  test("Correcta estructura de pdf por estudiantes", () async {
    final query = RegisterBookFilter(orderBy: RegisterBookViewOrderByType.timestampOldy, classroomId: '6615024f-0153-4492-b06e-0cb108f90ac6');
    final ExportReportManager exporter = RegisterBookExportByStudent();
    ...
    final outputFile = File('${outputDir.path}/student_report.pdf');
    await outputFile.writeAsBytes(await doc.save());
